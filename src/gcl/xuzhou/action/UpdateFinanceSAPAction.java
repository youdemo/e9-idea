...
public class UpdateFinanceSAPAction extends BaseBean implements Action {
    ...
    public String execute(RequestInfo info) {
        ...
        this.writeLog("回传财务数据到SAP PI Action开始：" + requestid);
        ...
        this.writeLog("回传财务数据到SAP PI Action完成：" + requestid);
