...
import sysnorg.tmc.util.TmcDBUtil;
...
public class HrmOrgAction {
	...
	public ReturnInfo operResource(HrmResourceBean hrb){
		...
		if(id < 1){
			...
			mapStr.put("joblevel", ""+hrb.getJoblevel());
...
//			mapStr.put("workcode", workcode);
		...
		//更新拼音简称
		String quickSearchStr = new HrmCommonServiceImpl().generateQuickSearchStr(hrb.getLastname());
