 ...
 */
public class KunShanDTAdapter20200527 {
    ...
    private static Logger log = Logger.getLogger(KunShanDTAdapter20200527.class.getName());
    ...
    public KunShanDTAdapter20200527() throws NoSuchAlgorithmException {
        rsa = new RSA4DotNet();
    }
