 ...
 */
public class KunShanDTAdapter20200604 {
    ...
    private static Logger log = Logger.getLogger(KunShanDTAdapter20200604.class.getName());
    ...
    public KunShanDTAdapter20200604() throws NoSuchAlgorithmException {
        rsa = new RSA4DotNet();
    }
