 ...
 * 统计内参发文流程 推送公文到政府oa
 */
public class SendDocForTJNCFW implements Action {
    @Override
    public String execute(RequestInfo info) {
        ...
        log.writeLog("SendDocForTJNCFW","开始推送公文 requestid："+requestid);
        ...
        if(rs.next()){
            ...
            fsfw = Util.null2String(rs.getString("xzdw"));
        ...
        if("1".equals(wsfboa)){
            ...
            try {
                ...
                log.writeLog("SendDocForTJNCFW",e);
                info.getRequestManager().setMessagecontent("推送公文失败，请联系系统管理员");
                info.getRequestManager().setMessageid("ErrorMsg:");
                return FAILURE_AND_CONTINUE;
