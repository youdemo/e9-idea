 ...
 * 采购订单同意调用cloud接口
 */
public class OaToCloudTYForPO implements Action{
	public String execute(RequestInfo info) {
		...
		try {
		    ...
		    if (resultLogin) {
		        ...
		        tu.writeLog("OaToCloudTYForPO requestid："+requestid+" sContent:"+content);
		        String result = client.audit("PUR_PurchaseOrder", content);
		        tu.writeLog("OaToCloudTYForPO requestid："+requestid+" sResult:"+result);
