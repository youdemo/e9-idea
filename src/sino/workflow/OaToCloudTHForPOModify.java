 ...
 * 采购订单变更退回调用cloud接口
 */
public class OaToCloudTHForPOModify implements Action{
	public String execute(RequestInfo info) {
		...
		try {
		    ...
		    if (resultLogin) {
		        ...
		        tu.writeLog("OaToCloudTHForPOModify requestid："+requestid+" sContent:"+content);
		        String result = client.excuteOperation("PUR_POChange","Cancel",content);
		        tu.writeLog("OaToCloudTHForPOModify requestid："+requestid+" sResult:"+result);
