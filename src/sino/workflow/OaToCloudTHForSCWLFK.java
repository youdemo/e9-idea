 ...
 * 生产物料付款退回调用cloud接口
 */
public class OaToCloudTHForSCWLFK implements Action{
	public String execute(RequestInfo info) {
		...
		try {
		    ...
		    if (resultLogin) {
		        ...
		        tu.writeLog("OaToCloudTHForSCWLFK requestid："+requestid+" sContent:"+content);
		        String result = client.excuteOperation("CN_PAYAPPLY","Cancel",content);
		        tu.writeLog("OaToCloudTHForSCWLFK requestid："+requestid+" sResult:"+result);
