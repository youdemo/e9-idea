 ...
 * 采购订单变更同意调用cloud接口
 */
public class OaToCloudTYForPOModify implements Action{
	public String execute(RequestInfo info) {
		...
		try {
		    ...
		    if (resultLogin) {
		        String content = "{\"CreateOrgId\":0,\"Numbers\":[\""+lcbh+"\"],\"Ids\":\"\",\"InterationFlags\":\"\"}";
		        tu.writeLog("OaToCloudTYForPOModify requestid："+requestid+" sContent:"+content);
		        String result = client.audit("PUR_POChange", content);
		        tu.writeLog("OaToCloudTYForPOModify requestid："+requestid+" sResult:"+result);
