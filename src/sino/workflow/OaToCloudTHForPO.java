 ...
 * 采购订单退回调用cloud接口
 */
public class OaToCloudTHForPO implements Action{
	public String execute(RequestInfo info) {
		...
		try {
		    ...
		    if (resultLogin) {
		        ...
		        tu.writeLog("OaToCloudTHForPO requestid："+requestid+" sContent:"+content);
		        String result = client.excuteOperation("PUR_PurchaseOrder","Cancel",content);
		        tu.writeLog("OaToCloudTHForPO requestid："+requestid+" sResult:"+result);
