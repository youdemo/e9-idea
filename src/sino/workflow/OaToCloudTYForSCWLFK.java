 ...
 * 生产物料同意调用cloud接口
 */
public class OaToCloudTYForSCWLFK implements Action{
	public String execute(RequestInfo info) {
		...
		try {
		    ...
		    if (resultLogin) {
		        ...
		        tu.writeLog("OaToCloudTYForSCWLFK requestid："+requestid+" sContent:"+content);
		        String result = client.audit("CN_PAYAPPLY", content);
		        tu.writeLog("OaToCloudTYForSCWLFK requestid："+requestid+" sResult:"+result);
