...
* @version 1.0  费用报销单
*/
public class ExpenseReimbursement  implements Action{
	...
	public String execute(RequestInfo info) {
		...
		if(Util.getDoubleValue(sjxfkjehj,0)>0){
			sb.append("\"FPayBox\": \"1\",");
		}else{
			sb.append("\"FPayBox\": \"\",");
		}
...
//			}
			...
			sb.append(" \"FTaxSubmitAmt\": "+bhsje+", \"FTaxRate\": "+fpsl+", \"FTaxAmt\": "+se+", \"FExpenseAmount\": "+je+", \"FProductID\": { \"FNUMBER\": \"\" }, \"FExpenseDeptEntryID\": {  \"FNUMBER\": \""+k3fycdbm+"\" }, \"FRequestAmount\": "+fkje_mx+", \"FExpSubmitAmount\": "+je+", \"FReqSubmitAmount\": "+fkje_mx+", \"FBankType\": {   \"FNUMBER\": \"\"  },  \"FSettlleTypeID\": {  \"FNUMBER\": \"\" },");
