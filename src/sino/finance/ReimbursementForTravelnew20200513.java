...
* @version 1.0 差旅费报销单
*/
public class ReimbursementForTravelnew20200513 implements Action{
...
//		String fkje = "";//付款金额  明细表1---单行文本框
		...
		String zjljdid = Util.null2o(weaver.file.Prop.getPropValue("k3cloudmt", "clbxzjl"));
		String zgsh = "";//主管审核
		String zgshsj = "";
		String cwsh = "";//财务审核
		String cwshsj = "";
		...
		sb.append("\"FOUTCONTACTUNITTYPE\": \"\", \"FCONTACTUNITTYPE\": \"BD_Empinfo\", \"FOUTCONTACTUNIT\": { \"FNumber\": \"\" }, \"FCONTACTUNIT\": { \"FNumber\": \""+skrgh+"\" }, \"FPayOrgId\": { \"FNumber\": \""+fyszgsbm+"\"  }, \"FPaySettlleTypeID\": {  \"FNUMBER\": \""+gu.getFieldVal("uf_jsfs", "bm", "id", jsfs)+"\"  }, \"FRefundBankAccount\": { \"FNUMBER\": \""+yxzh+"\" },\"FBankBranchT\": \""+khyx+"\", \"FBankAccountNameT\": \""+zhmc+"\",");
		...
		if(Util.getDoubleValue(bxzje,0)>0){
			sb.append("\"FPayBox\": \"1\",");
		}else{
			sb.append("\"FPayBox\": \"\",");
		}
		...
		sb.append("\"FCountry\": \"\",  \"FNProvince\": \"\", \"FNCity\": \"\", \"FNDistrict\": \"\",  \"F_ORA_RSCPROJECT\": { \"FNumber\": \""+gu.getFieldVal("uf_yfxm", "bm", "id", yfxm)+"\" }, \"F_ORA_ENGPROJECT\": { \"FNumber\": \"\" },\"F_ORA_LEADERCHECK\": \""+zgsh+"\", \"F_ORA_GMCHECK\": \""+zjlsh+"\",\"F_ORA_FICHECK\": \""+cwsh+"\",\"F_ORA_ACCTCHECK\": \""+cnsh+"\",\"F_ORA_LEADERDATE\": \""+zgshsj+"\",\"F_ORA_GMDATE\": \""+zjlshsj+"\", \"F_ORA_FIDATE\": \""+cwshsj+"\",\"F_ORA_ACCTDATE\": \""+cnshsj+"\", \"FRequestType\": \"1\",\"FCombinedPay\": \"true\",\"FEntity\": [");
