 ...
 * 车辆使用 导出excel
 */
public class CarReportGetExcel20200403 {
    ...
    public HSSFWorkbook createExcel(String searchday) throws Exception {
        ...
        int jsrcount = 0;
        String sql = "select count(1) as count from (select jsy from formtable_main_68 a,workflow_requestbase b where a.requestId=b.requestid and b.currentnodetype=3 and yjccrq1='"+searchday+"' and jsy is not null group by jsy)a";
        rs.execute(sql);
        if(rs.next()){
...
// 设置边框
            ...
            sql = "select jsy,(select lastname from hrmresource where id=a.jsy) as jsyname from formtable_main_68 a,workflow_requestbase b where a.requestId=b.requestid and b.currentnodetype=3 and yjccrq1='"+searchday+"' and jsy is not null group by jsy";
            rs.execute(sql);
            int i =0;
            while(rs.next()) {
            ...
            for(String jsrid:jsrarr) {
                String sj = "";
                sql = "select sbsj+'~'+xbsj as sj from formtable_main_68 a,workflow_requestbase b where a.requestId=b.requestid and b.currentnodetype=3 and yjccrq1='" + searchday + "' and jsy=" + jsrid + " and (sbsj is not null and sbsj <> '' )";
                rs.execute(sql);
                if (rs.next()) {
            ...
            for(String jsrid:jsrarr){
                ...
                while(rs.next()){
                    ...
                    String ycqk = Util.null2String(rs.getString("yjccsj1"))+"出发，乘车人："+ccrynames+"，目的地:"+Util.null2String(rs.getString("mdd"))+"，"+Util.null2String(rs.getString("yjfhsj1"))+"返回";
