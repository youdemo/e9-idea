package xhgz.report.lhbomsq.WEB;
...
import xhgz.report.lhbomsq.SERVICE.IMPL.XhgzLhBomServiceImpl;
...
public class XhgzLhBomAction {

    private XhgzLhBomServcie getService(User user) {
        return (XhgzLhBomServiceImpl) ServiceUtil.getService(XhgzLhBomServiceImpl.class, user);
    }
