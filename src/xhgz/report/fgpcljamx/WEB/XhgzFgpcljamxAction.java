package xhgz.report.fgpcljamx.WEB;
...
import xhgz.report.fgpcljamx.SERVICE.IMPL.XhgzFgpcljamxServiceImpl;
...
public class XhgzFgpcljamxAction {

    private XhgzFgpcljamxServcie getService(User user) {
        return (XhgzFgpcljamxServiceImpl) ServiceUtil.getService(XhgzFgpcljamxServiceImpl.class, user);
    }
