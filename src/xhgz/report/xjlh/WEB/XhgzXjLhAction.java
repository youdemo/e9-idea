...
import xhgz.report.xjlh.SERVICE.IMPL.XhgzXjLhServiceImpl;
...
/**
 * @author
 * @date 2020/5/13 0013 - 上午 9:42
 */
public class XhgzXjLhAction {

    private XhgzXjLhServcie getService(User user) {
        return (XhgzXjLhServiceImpl) ServiceUtil.getService(XhgzXjLhServiceImpl.class, user);
    }
