...
import xhgz.report.scmx.SERVICE.IMPL.XhgzScmxServiceImpl;
...
public class XhgzScmxAction {

    private XhgzScmxServcie getService(User user) {
        return (XhgzScmxServiceImpl) ServiceUtil.getService(XhgzScmxServiceImpl.class, user);
    }
