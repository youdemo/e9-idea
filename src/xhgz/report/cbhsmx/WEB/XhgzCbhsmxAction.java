package xhgz.report.cbhsmx.WEB;
...
import xhgz.report.cbhsmx.SERVICE.IMPL.XhgzCbhsmxServiceImpl;
...
public class XhgzCbhsmxAction {

    private XhgzCbhsmxServcie getService(User user) {
        return (XhgzCbhsmxServiceImpl) ServiceUtil.getService(XhgzCbhsmxServiceImpl.class, user);
    }
