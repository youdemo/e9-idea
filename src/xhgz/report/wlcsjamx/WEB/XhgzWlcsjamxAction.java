package xhgz.report.wlcsjamx.WEB;
...
import xhgz.report.wlcsjamx.SERVICE.IMPL.XhgzWlcsjamxServiceImpl;
 ...
 * 物料测试接案明细
 **/
public class XhgzWlcsjamxAction {

    private XhgzWlcsjamxServcie getService(User user) {
        return (XhgzWlcsjamxServiceImpl) ServiceUtil.getService(XhgzWlcsjamxServiceImpl.class, user);
    }
