...
public class ChangeCustomInfo20200212 implements Action {
    @Override
    public String execute(RequestInfo info) {
        ...
        String jcsjxg = "1";// 0 是 1 否
        String khflxxxg = "1";//0 是 1 否
        String buxxxg = "1";//0 是 1 否
        String sql = "select * from "+tableName+" where requestid="+requestid;
        String billid = "";
        rs.execute(sql);
        if(rs.next()){
            billid = Util.null2String(rs.getString("khmc"));
            baseMap.put("khmc", Util.null2String(rs.getString("khmcnew")));//客户名称
            ...
            baseMap.put("sfczmyjt", Util.null2String(rs.getString("sfczmyjt")));//是否从属某一集团
            ...
            khflMap.put("hyzfl", Util.null2String(rs.getString("hyzfl")));//行业子分类
            khflMap.put("szqy", Util.null2String(rs.getString("szqy")));//所在区域
            khflMap.put("khqz", Util.null2String(rs.getString("khqz")));//客户群组
            khflMap.put("oemodmjt", Util.null2String(rs.getString("oemodmjt")));//OEM/ODM集团
            khflMap.put("cpx", Util.null2String(rs.getString("cpx")));//产品线
        ...
        sql = "select * from uf_xzkhsp where id="+billid;
        rs.execute(sql);
        if(rs.next()){
            ...
            baseMapMode.put("sfczmyjt", Util.null2String(rs.getString("sfczmyjt")));//是否从属某一集团
            ...
            khflMapMode.put("hyzfl", Util.null2String(rs.getString("hyzfl")));//行业子分类
            khflMapMode.put("szqy", Util.null2String(rs.getString("szqy")));//所在区域
            khflMapMode.put("khqz", Util.null2String(rs.getString("khqz")));//客户群组
            khflMapMode.put("oemodmjt", Util.null2String(rs.getString("oemodmjt")));//OEM/ODM集团
            khflMapMode.put("cpx", Util.null2String(rs.getString("cpx")));//产品线
        ...
        sql = "update "+tableName+" set jcsjxg='"+jcsjxg+"',khflxxxg='"+khflxxxg+"',buxxxg='"+buxxxg+"' where requestid="+requestid;
