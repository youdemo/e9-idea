package APPDEV.HQ.ENGINE.FNA.TL.HOTEL.WEB;

import APPDEV.HQ.ENGINE.FNA.TL.HOTEL.SERVICE.HotelOrderDataServcie;
import APPDEV.HQ.ENGINE.FNA.TL.HOTEL.SERVICE.IMPL.HotelOrderDataServcieImpl;
 ...
 * 酒店对账列表
 **/
public class HotelOrderDataAction {

    private HotelOrderDataServcie getService(User user) {
        return (HotelOrderDataServcieImpl) ServiceUtil.getService(HotelOrderDataServcieImpl.class, user);
    }
