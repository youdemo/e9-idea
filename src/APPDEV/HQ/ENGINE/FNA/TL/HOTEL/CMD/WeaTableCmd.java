    ...
    public Map<String, Object> execute(CommandContext commandContext) {
       ...
       // }
        ...
        try {
            ...
            String pageID = "738c0166-23d0-442d-a155-3808a88f4134";
            ...
            table.getColumns().add(new WeaTableColumn("10%", "差旅单号", "requestid","requestid","APPDEV.HQ.ENGINE.FNA.TL.HOTEL.CMD.WeaTableTransMethod.getRequestUrl","column:WFStatus"));
            ...
            table.getColumns().add(new WeaTableColumn("10%", "酒店总金额", "xcjpzje","xcjpzje","APPDEV.HQ.ENGINE.FNA.TL.HOTEL.CMD.WeaTableTransMethod.getjpctUrl",otherparam));
            ...
            checkboxpopedom.setShowmethod("APPDEV.HQ.ENGINE.FNA.TL.HOTEL.CMD.WeaTableTransMethod.canCheck");
