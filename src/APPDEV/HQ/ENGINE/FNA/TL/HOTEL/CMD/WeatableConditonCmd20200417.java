...
public class WeatableConditonCmd20200417 extends AbstractCommonCommand<Map<String,Object>> {

    public WeatableConditonCmd20200417(User user, Map<String,Object> params) {
        this.user = user;
        this.params = params;
    }
