...
public class WeaTableTransMethod {
    ...
    public static String getjpctUrl(String param,String param2){
        ...
        String result = showvalue;
        if(!"".equals(param)){
            result = "<a href='/wui/index.html?hideHeader=true&hideAside=true#/main/cs/app/bcec8ce439084c3c9fa235d9a3ccab7c_hotelorderDetail?rqid="+params[0]+"&IsDomestic=true&lastmonth="+params[1]+"' target='_blank'>"+showvalue+"</a>";
        }
        return result;
    }
