package APPDEV.HQ.ENGINE.FNA.TL.TRAVELFEEREPORT.WEB;

import APPDEV.HQ.ENGINE.FNA.TL.TRAVELFEEREPORT.SERVICE.IMPL.TravelFeeReportServcieImpl;
 ...
 * 机票对账列表
 **/
public class TravelFeeReportAction {

    private TravelFeeReportDataServcie getService(User user) {
        return (TravelFeeReportServcieImpl) ServiceUtil.getService(TravelFeeReportServcieImpl.class, user);
    }
