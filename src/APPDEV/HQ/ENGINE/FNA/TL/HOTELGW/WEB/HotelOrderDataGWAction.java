package APPDEV.HQ.ENGINE.FNA.TL.HOTELGW.WEB;

import APPDEV.HQ.ENGINE.FNA.TL.HOTELGW.SERVICE.HotelOrderDataGWServcie;
import APPDEV.HQ.ENGINE.FNA.TL.HOTELGW.SERVICE.IMPL.HotelOrderDataGWServcieImpl;
 ...
 * 酒店对账列表
 **/
public class HotelOrderDataGWAction {

    private HotelOrderDataGWServcie getService(User user) {
        return (HotelOrderDataGWServcieImpl) ServiceUtil.getService(HotelOrderDataGWServcieImpl.class, user);
    }
