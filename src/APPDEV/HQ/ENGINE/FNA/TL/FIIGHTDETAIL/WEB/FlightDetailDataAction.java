package APPDEV.HQ.ENGINE.FNA.TL.FIIGHTDETAIL.WEB;

import APPDEV.HQ.ENGINE.FNA.TL.FIIGHTDETAIL.SERVICE.FlightDetailDataServcie;
import APPDEV.HQ.ENGINE.FNA.TL.FIIGHTDETAIL.SERVICE.IMPL.FlightDetailDataServcieImpl;
 ...
 * 机票穿透明细
 **/
public class FlightDetailDataAction {

    private FlightDetailDataServcie getService(User user) {
        return (FlightDetailDataServcieImpl) ServiceUtil.getService(FlightDetailDataServcieImpl.class, user);
    }
