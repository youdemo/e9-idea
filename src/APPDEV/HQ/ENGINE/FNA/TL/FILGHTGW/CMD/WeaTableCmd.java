package APPDEV.HQ.ENGINE.FNA.TL.FILGHTGW.CMD;
    ...
    public Map<String, Object> execute(CommandContext commandContext) {
       ...
       // }
        try {
            ...
            String pageID = "9a67eb29-b3f7-47ed-832c-ee4e0aa1d3c9";
            ...
            table.getColumns().add(new WeaTableColumn("7%", "差旅单号", "requestid","requestid","APPDEV.HQ.ENGINE.FNA.TL.FILGHTGW.CMD.WeaTableTransMethod.getRequestUrl",otherparam2));
            ...
            table.getColumns().add(new WeaTableColumn("6%", "总金额", "xcjpzje","xcjpzje","APPDEV.HQ.ENGINE.FNA.TL.FILGHTGW.CMD.WeaTableTransMethod.getjpctUrl",otherparam));
            ...
            table.getColumns().add(new WeaTableColumn("5%", "退票费", "REFUND","REFUND","APPDEV.HQ.ENGINE.FNA.TL.FIIGHT.CMD.WeaTableTransMethod.setcolor",otherparam2));
            table.getColumns().add(new WeaTableColumn("5%", "个人支付", "grzfje","grzfje","APPDEV.HQ.ENGINE.FNA.TL.FIIGHT.CMD.WeaTableTransMethod.setcolor",otherparam2));
            ...
            checkboxpopedom.setShowmethod("APPDEV.HQ.ENGINE.FNA.TL.FILGHTGW.CMD.WeaTableTransMethod.canCheck");
