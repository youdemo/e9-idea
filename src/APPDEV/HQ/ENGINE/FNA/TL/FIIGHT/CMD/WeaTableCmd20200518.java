...
public class WeaTableCmd20200518 extends AbstractCommonCommand<Map<String,Object>> {
    public WeaTableCmd20200518(User user, Map<String,Object> params) {
        this.user = user;
        this.params = params;
    }
    ...
    public Map<String, Object> execute(CommandContext commandContext) {
       ...
       // }
        try {
            ...
            String fileds = "requestid,xcydsy,rzgsbm,costcenter,xcjpzje,sfbx,BtrPER,BTRBEGDA,BTRENDDA,WFStatus,REBOOKQUERYFEE,REFUND,tjcs,hzje,'"+lastmonth+"' as lastmonth ";
            ...
            table.getColumns().add(new WeaTableColumn("9%", "差旅单号", "requestid","requestid","APPDEV.HQ.ENGINE.FNA.TL.FIIGHT.CMD.WeaTableTransMethod.getRequestUrl",otherparam2));
            table.getColumns().add(new WeaTableColumn("9%", "出差人", "BtrPER","BtrPER","APPDEV.HQ.ENGINE.FNA.TL.FIIGHT.CMD.WeaTableTransMethod.setcolor",otherparam2));
            table.getColumns().add(new WeaTableColumn("9%", "差旅开始", "BTRBEGDA","BTRBEGDA","APPDEV.HQ.ENGINE.FNA.TL.FIIGHT.CMD.WeaTableTransMethod.setcolor",otherparam2));
            table.getColumns().add(new WeaTableColumn("9%", "差旅结束", "BTRENDDA","BTRENDDA","APPDEV.HQ.ENGINE.FNA.TL.FIIGHT.CMD.WeaTableTransMethod.setcolor",otherparam2));
            table.getColumns().add(new WeaTableColumn("8%", "差旅状态", "WFStatus","WFStatus","APPDEV.HQ.ENGINE.FNA.TL.FIIGHT.CMD.WeaTableTransMethod.setcolor",otherparam2));
            table.getColumns().add(new WeaTableColumn("8%", "是否报销", "sfbx","sfbx","APPDEV.HQ.ENGINE.FNA.TL.FIIGHT.CMD.WeaTableTransMethod.setcolor",otherparam2));
            //table.getColumns().add(new WeaTableColumn("10%", "携程预定事由", "xcydsy","xcydsy"));
            table.getColumns().add(new WeaTableColumn("10%", "入账公司", "rzgsbm","rzgsbm","APPDEV.HQ.ENGINE.FNA.TL.FIIGHT.CMD.WeaTableTransMethod.setcolor",otherparam2));
            table.getColumns().add(new WeaTableColumn("10%", "成本中心", "costcenter","costcenter","APPDEV.HQ.ENGINE.FNA.TL.FIIGHT.CMD.WeaTableTransMethod.setcolor",otherparam2));
            table.getColumns().add(new WeaTableColumn("10%", "机票总金额", "xcjpzje","xcjpzje","APPDEV.HQ.ENGINE.FNA.TL.FIIGHT.CMD.WeaTableTransMethod.getjpctUrl",otherparam));
            table.getColumns().add(new WeaTableColumn("10%", "历史汇总金额", "hzje","hzje","APPDEV.HQ.ENGINE.FNA.TL.FIIGHT.CMD.WeaTableTransMethod.setcolor",otherparam2));
            //table.getColumns().add(new WeaTableColumn("6%", "改签费", "REBOOKQUERYFEE","REBOOKQUERYFEE"));
            table.getColumns().add(new WeaTableColumn("8%", "退票费", "REFUND","REFUND","APPDEV.HQ.ENGINE.FNA.TL.FIIGHT.CMD.WeaTableTransMethod.setcolor",otherparam2));
