package APPDEV.HQ.ENGINE.FNA.TL.TRAVELQUERY.WEB;

import APPDEV.HQ.ENGINE.FNA.TL.TRAVELQUERY.SERVICE.TravelQueryDataServcie;
import APPDEV.HQ.ENGINE.FNA.TL.TRAVELQUERY.SERVICE.IMPL.TravelQueryServcieImpl;
 ...
 * 机票对账列表
 **/
public class TravelQueryAction {

    private TravelQueryDataServcie getService(User user) {
        return (TravelQueryServcieImpl) ServiceUtil.getService(TravelQueryServcieImpl.class, user);
    }
