						...
						if (Itinerary.length() > 0) {
							...
							if (HotelOrderInfoList != null && HotelOrderInfoList.length() > 0) {
								for (int HotelIndex = 0; HotelIndex < HotelOrderInfoList.length(); HotelIndex++) {
									...
									String PayType = hotelOrderInfo.getString("PayType");
									if("已取消".equals(OrderDetailStatusName)|| "未提交".equals(OrderDetailStatusName) || !"公费".equals(Corp_payType)|| !"公司账户".equals(PayType)){
										continue;
									}
