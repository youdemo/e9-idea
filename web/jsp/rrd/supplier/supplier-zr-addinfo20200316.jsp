...
<script type="text/javascript">
    ...
    jQuery(document).ready(function () {
       ...
       jQuery("#sfyyyxgfj").bind("change",function(){
           changemustfield();
       })
        jQuery("#sfyyhxgfj").bind("change",function(){
            changemustfield();
        })
        jQuery("#sfysyxgfj").bind("change",function(){
            changemustfield();
        })
        changemustfield();
    })
    ...
    function changemustfield(){
        var sfyyyxgfj_val = jQuery("#sfyyyxgfj").val();//是否有营业相关附件
        var sfyyhxgfj_val = jQuery("#sfyyhxgfj").val();//是否有银行相关附件
        var sfysyxgfj_val = jQuery("#sfysyxgfj").val();//是否有商业相关附件
        if(sfyyyxgfj_val == "1"){
            addcheck("yyzzlysm","0");
    ...
    function save(type){
        ...
        if((!oUpload_yyzzjggz || oUpload_yyzzjggz.getStats().files_queued === 0)
            ...
            if(!oUpload_yyzzjggz || oUpload_yyzzjggz.getStats().files_queued === 0){
                count = count+1;
                flag_yyzzjggz = "0";
                if(yyzzjggz_val == "" && sfyyyxgfj_val == "0"){
                    alert("有附件信息没上传，请上传相关附件");
                    return;
                }
            ...
            if(!oUpload_yhkhxxjggz || oUpload_yhkhxxjggz.getStats().files_queued === 0){
                count = count+1;
                flag_yhkhxxjggz="0";
                if(yhkhxxjggz_val == "" && yhkhxxjggz_val == "0"){
                    alert("有附件信息没上传，请上传相关附件");
                    return;
                }
            }
            ...
            if(!oUpload_syddhjggz || oUpload_syddhjggz.getStats().files_queued === 0){
                count = count+1;
                flag_syddhjggz = "0";
                if(syddhjggz_val == "" && syddhjggz_val == "0"){
                    alert("有附件信息没上传，请上传相关附件");
                    return;
                }
            }
