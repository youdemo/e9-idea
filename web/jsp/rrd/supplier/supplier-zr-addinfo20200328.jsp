                        ...
                        <div style="overflow-x: auto; min-height: 1140px; padding-bottom: 20px;background-color: #fff;">
                            <table class="excelMainTable" style="margin: 0px auto; width: 1189px;" _haspercent="true">
                                ...
                                <tr class="tr_normal" id="wbhyc">
                                    ...
                                    <td class="td_fieldnameleft"><div class="div_fieldname">：</div></td>
                                    <td class="td_fieldvalue"><div width="100%"><%=sisi.getFieldHtml("wb",sid.getGlgs(),"text","1","50","26")%></div></td>
                                    <td class="td_fieldnameright"><div class="div_fieldname">银行账号（外币)</div></td>
                                    <td class="td_fieldnameleft"><div class="div_fieldname">：</div></td>
                                    <td class="td_fieldvalue" colspan="2"><div width="100%"><%=sisi.getFieldHtml("yhzhwb",sid.getGlgs(),"text","1","50","26")%></div></td>
                                    <td class="td_fieldnameright" colspan="2"><div class="div_fieldname">SWIFT CODE</div></td>
                                    <td class="td_fieldnameleft"><div class="div_fieldname">：</div></td>
                                    <td class="td_fieldvalue" colspan="2"><div width="100%"><%=sisi.getFieldHtml("swiftcode",sid.getGlgs(),"text","1","50","26")%></div></td>
                                </tr>
                                ...
                                <tr class="tr_normal">
                                    ...
                                    <td class="td_fieldnameleft"><div class="div_fieldname">：</div></td>
                                    <td class="td_fieldvalue" colspan="2"><div width="100%"><%=tu.getSelectHtmlTable("hya",sid.getSzhy(),"1","uf_khsshy","drdl01","id","DRKY","asc")%></div></td>
                                ...
                                <tr class="tr_normal">
                                    ...
                                    <td class="td_fieldnameleft"><div class="div_fieldname">：</div></td>
                                    <td class="td_fieldvalue" colspan="2"><div width="100%"><%=tu.getSelectHtmlTable("hyb",sid.getSzhy(),"1","uf_khsshy","drdl01","id","DRKY","asc")%></div></td>
                                ...
                                <tr class="tr_normal">
                                    ...
                                    <td class="td_fieldnameleft"><div class="div_fieldname">：</div></td>
                                    <td class="td_fieldvalue" colspan="2"><div width="100%"><%=tu.getSelectHtmlTable("hyc",sid.getSzhy(),"1","uf_khsshy","drdl01","id","DRKY","asc")%></div></td>
                                ...
                                <tr class="tr_normal1" id="yyzzxzyc">
                                    <td></td>
                                    <td class="td_fieldnamemid"><div class="div_fieldname" >营业如无请说明理由</div></td>
                                    <td></td>
                                ...
                                <tr class="tr_normal1" id="yhkhxzyc">
                                    <td></td>
                                    <td class="td_fieldnamemid"><div class="div_fieldname" >银行如无请说明理由</div></td>
                                    <td></td>
                                ...
                                <tr class="tr_normal1" id="syddxzyc">
                                    <td></td>
                                    <td class="td_fieldnamemid"><div class="div_fieldname" >商业如无请说明理由</div></td>
                                    <td></td>
                                ...
                                <tr class="tr_normal1" id="cwxxxzyc">
                                    <td></td>
                                    <td class="td_fieldnamemid"><div class="div_fieldname" >财务如无请说明理由</div></td>
                                    <td></td>
                                ...
                                <tr class="tr_normal1" id="gsjbxxxzyc">
                                    <td></td>
                                    <td class="td_fieldnamemid"><div class="div_fieldname" >公司如无请说明理由</div></td>
                                    <td></td>
