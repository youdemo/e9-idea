                    ...
                    <div style="line-height: 35px;white-space: nowrap;text-overflow: ellipsis;position: relative;margin-left: 0;margin-right: 0;height: auto;zoom: 1;display: block; width: 94%;margin-bottom: 5px;">
                        ...
                        <div  style="text-align: right; margin-top: -5px;">
                            <div>
                                ...
                                <button type="button" class="ant-btn ant-btn-primary" onclick="zancun()"><span>暂存</span> </button>
                                </span>
                                <span style="display: inline-block; line-height: 28px; vertical-align: middle; margin-left: 10px;">
                                    <button type="button" class="ant-btn ant-btn-primary" onclick="tijiao()"><span>提交</span></button></span>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="contentbody" id="divinner"style="width: 100%;overflow: auto;background-color: #f1f1f1;height: 873px;overflow-x: hidden;overflow-y: auto;position: relative;z-index: 0;">
            <div style="height: auto;">
                <div  style="min-height: 1204px; padding: 30px 40px;">
                    <FORM id=report name=report action="/alarm/refresh.jsp" method=post>
...
<script type="text/javascript">
    ...
    window.onload = function() {
        ...
        try{
           ...
           // jQuery("#spanButtonPlaceHolder_yyzzjggz").html("<span><img src=\"/rrd/supplier/img/sc.png\"  border=\"0\"></span>");
    ...
    function zancun(){
        ...
        //sunmit 点击事件
            ...
            if (!oUpload_yyzzjggz) {
                ...
                try {
                    alert(oUpload_yyzzjggz.getStats().files_queued);
                    if (oUpload_yyzzjggz.getStats().files_queued === 0) {
                        //report.submit();
                    } else {
                        alert("2222");
