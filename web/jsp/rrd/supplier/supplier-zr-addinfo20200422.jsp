...
<%
    ...
    String chkFields = "gsxz,ssqy,gysmc,szhy,jyzx,ywfwgjyyzz,clsj,gsdh,gyszcdz,zczbw,nxsew,gysjydz,fddbr,glzlxr," +
            ...
            "sfyyyzzjggz,sfyyhkhxxjggz,sfysyddhjggz,sfycwxgfj,cwrwqsmly,sfygsxgfj,gsrwqsmly,bz1,khh1,yhzh1";
%>
<head>
    <title>供应商信息收集</title>
                        ...
                        <div style="overflow-x: auto; min-height: 1140px; padding-bottom: 20px;background-color: #fff;">
                            <table class="excelMainTable" style="margin: 0px auto; width: 1204px;" _haspercent="true">
                                ...
                                <tr class="tr_normal">
                                    ...
                                    <td></td>
                                    <td class="td_fieldnamecenter" colspan="2"><div width="100%">币种</div></td>

                                    <td class="td_fieldnamecenter" colspan="2"><div width="100%"style="padding-right: 20px;">开户行</div></td>
                                    <td></td>
                                    <td class="td_fieldnamecenter" colspan="4"><div width="100%"style="padding-right: 25px;">银行账号</div></td>
                                    <td></td>
                                    <td class="td_fieldnamecenter" colspan="2"><div width="100%"style="padding-right: 15px;">SWIFT CODE</div></td>
                                </tr>
                                <tr class="tr_normal">
                                    <td></td>
                                    <td class="td_fieldvalue" colspan="2"><div width="100%"><%=tu.getSelectHtmlTable2("bz1",sid.getBz1(),"1","uf_jyhb","cvcrcd","id","cvcrcd","desc","100")%></div></td>
                                    <td class="td_fieldvalue" colspan="2"><div width="100%"><%=sisi.getFieldHtml("khh1",sid.getKhh1(),"text","1","200","40")%></div></td>
                                    <td ></td>
                                    <td class="td_fieldvalue" colspan="4"><div width="100%"><%=sisi.getFieldHtml("yhzh1",sid.getYhzh1(),"text","1","200","55")%></div></td>
                                    <td ></td>
                                    <td class="td_fieldvalue" colspan="2"><div width="100%"><%=sisi.getFieldHtml("swiftcode1",sid.getSwiftcode1(),"text","0","200","26")%></div></td>
                                </tr>
                                <tr class="tr_normal">
                                    <td></td>
                                    <td class="td_fieldvalue" colspan="2"><div width="100%"><%=tu.getSelectHtmlTable2("bz2",sid.getBz2(),"0","uf_jyhb","cvcrcd","id","cvcrcd","desc","100")%></div></td>
                                    <td class="td_fieldvalue" colspan="2"><div width="100%"><%=sisi.getFieldHtml("khh2",sid.getKhh2(),"text","0","200","40")%></div></td>
                                    <td ></td>
                                    <td class="td_fieldvalue" colspan="4"><div width="100%"><%=sisi.getFieldHtml("yhzh2",sid.getYhzh2(),"text","0","200","55")%></div></td>
                                    <td ></td>
                                    <td class="td_fieldvalue" colspan="2"><div width="100%"><%=sisi.getFieldHtml("swiftcode2",sid.getSwiftcode2(),"text","0","200","26")%></div></td>
                                </tr>
                                <tr class="tr_normal">
                                    <td></td>
                                    <td class="td_fieldvalue" colspan="2"><div width="100%"><%=tu.getSelectHtmlTable2("bz3",sid.getBz3(),"0","uf_jyhb","cvcrcd","id","cvcrcd","desc","100")%></div></td>
                                    <td class="td_fieldvalue" colspan="2"><div width="100%"><%=sisi.getFieldHtml("khh3",sid.getKhh3(),"text","0","200","40")%></div></td>
                                    <td ></td>
                                    <td class="td_fieldvalue" colspan="4"><div width="100%"><%=sisi.getFieldHtml("yhzh3",sid.getYhzh3(),"text","0","200","55")%></div></td>
                                    <td ></td>
                                    <td class="td_fieldvalue" colspan="2"><div width="100%"><%=sisi.getFieldHtml("swiftcode3",sid.getSwiftcode3(),"text","0","200","26")%></div></td>
                                </tr>
