...
WebFXTreeItem.prototype.toString = function (nItem, nItemCount) {
	...
	if(tmpArray0=='wf'){
        ...
        if(flags){
            if(tmpArray3=='1')
                checkAllStr = "<input type=checkbox name='w"+tmpArray1+"'  value='W"+tmpArray2+"' onclick=checkSub(this,'"+tmpArray2+"','"+tmpArray1+"') checked>";
            else
                checkAllStr = "<input type=checkbox name='w"+tmpArray1+"'  value='W"+tmpArray2+"' onclick=checkSub(this,'"+tmpArray2+"','"+tmpArray1+"') >";
        }else{
            checkAllStr = "<input type=checkbox name='w"+tmpArray1+"'  value='W"+tmpArray2+"' onclick=checkSub(this,'"+tmpArray2+"','"+tmpArray1+"') "+c+" >";
        }
    ...
    var str = "<table onmouseover=\"document.getElementById('"+this.id+"-anchor').style.backgroundColor='#DDDDDD';document.getElementById('"+this.id+"-anchor').style.border='1px solid #0099CC';\" onmouseout=\"document.getElementById('"+this.id+"-anchor').style.backgroundColor='';document.getElementById('"+this.id+"-anchor').style.border='1px solid #FFFFFF';\" id=\"" + this.id + "\" ondblclick=\"webFXTreeHandler.toggle(this);\" class=\"webfx-tree-item\" onkeydown=\"return webFXTreeHandler.keydown(this, event)\" style=\"width:100%\" cellpadding=\"0\" cellspacing=\"0\"><tr onmouseover=\"this.style.backgroundColor='#DDDDDD';\" onmouseout=\"this.style.backgroundColor='';\"><td width=\"50%\">" +
		indent +
		"<img id=\"" + this.id + "-plus\" src=\"" + ((this.folder)?((this.open)?((this.parentNode._last)?webFXTreeConfig.lMinusIcon:webFXTreeConfig.tMinusIcon):((this.parentNode._last)?webFXTreeConfig.lPlusIcon:webFXTreeConfig.tPlusIcon)):((this.parentNode._last)?webFXTreeConfig.lIcon:webFXTreeConfig.tIcon)) + "\" onclick=\"webFXTreeHandler.toggle(this);\">" +
		"<img id=\"" + this.id + "-icon\" class=\"webfx-tree-icon\" src=\"" + ((webFXTreeHandler.behavior == 'classic' && this.open)?this.openIcon:this.icon) + "\" onclick=\"webFXTreeHandler.select(this);\">" +
		"<span style=\"cursor:hand;border:1px solid #FFFFFF;padding:0 4px 0 4px\" id=\"" + this.id + "-anchor\" onfocus=\"webFXTreeHandler.focus(this);\" onblur=\"webFXTreeHandler.blur(this);\"" +
		(this.target ? " target=\"" + this.target + "\"" : "") +
		">" + label + "</span></td><td width=\"25%\">"+checkAllStr+"</td><td width=\"25%\"></td></tr></table>" +
		"<div id=\"" + this.id + "-cont\" class=\"webfx-tree-container\" style=\"display: " + ((this.open)?'block':'none') + ";\">";
	var sb = [];
	for (var i = 0; i < this.childNodes.length; i++) {
		sb[i] = this.childNodes[i].toString(i,this.childNodes.length);
