...
<jsp:useBean id="WorkflowComInfo" class="gcl.sjjk.WorkflowComInfoRight" scope="page"/>
...
int pzid = Util.getIntValue(request.getParameter("pzid"),0);
...
if(detachable==1)
	...
	subcomids1=CheckSubCompanyRight.getSubComByUserRightId(user.getUID(),"WorkflowMonitor:All");
out.println(WorkflowComInfo.getWFTreeXMLByType(workflowType,""+pzid,subcomids1,""+user.getUID(),typeid,subcompanyid,detachable));
