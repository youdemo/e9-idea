    ...
    if("add".equals(actionKey)){
        ...
        try{
            if(!"".equals(pzid)) {
                ...
                //new BaseBean().writeLog("testaaaa","typeid:"+typeid+" wfids:"+wfids);

                rs.executeSql("delete from "+tablename_jl+" where  workflowid in (select id from workflow_base where (workflowtype in ("+typeid+") or workflowtype not in ("+wfids+"))) and sjszid='" + pzid + "'");
        ...
        rs.executeSql("delete from "+tablename_jl+" where id='" + pzid + "'");
    }
    out.print("S");
