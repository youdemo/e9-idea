...
i_gncldj in varchar2,i_gwcldj in varchar2,i_mdd in varchar2,i_clfa in varchar2,i_type in varchar2,is_SENDCAR in varchar2)
--i_begindate 开始日期 i_enddate 结束日期 i_travelgroup 差旅组 i_gnw 国内外 i_gncldj国内差旅等级
--i_gwcldj 国外差旅等级 i_mdd 城市别 i_rswf 人事范围 i_clfa 差旅方案 i_type类型 0 单日 1 汇总 is_SENDCAR 是否全程派车 0否 1是
return  number is
