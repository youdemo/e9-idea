...
var AccCURR_dt10 = WfForm.convertFieldNameToId("AccCURR", "detail_10");//币种
var AccRate_dt10= WfForm.convertFieldNameToId("AccRate", "detail_10");//汇率
...
jQuery(document).ready(function(){
    ...
    WfForm.bindDetailFieldChangeEvent(AccCURR_dt10,function(id,rowIndex,value){
        var PayInDoll_val = WfForm.getFieldValue(PayInDoll);
        var hl_val = getHl(value,PayInDoll_val);
        WfForm.changeFieldValue(AccRate_dt10+"_"+rowIndex,{value:hl_val});

    });
    WfForm.registerAction(WfForm.ACTION_ADDROW+"10", function(index){
        var PayInDoll_val = WfForm.getFieldValue(PayInDoll);
        var AccCURR_dt10_val = WfForm.getFieldValue(AccCURR_dt10+"_"+index);
        var hl_val = getHl(AccCURR_dt10_val,PayInDoll_val);
        WfForm.changeFieldValue(AccRate_dt10+"_"+index,{value:hl_val});
    });
