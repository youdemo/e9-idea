...
jQuery(document).ready(function(){
    ...
    dealDt10();
    var changesedt10field = AccCOST_dt10+","+AccTaxRate_dt10+","+AccTaxM_dt10;
    WfForm.bindDetailFieldChangeEvent(changesedt10field,function(id,rowIndex,value){
        var AccCOST_dt10_val = WfForm.getFieldValue(AccCOST_dt10+"_"+rowIndex);
        var AccTaxRate_dt10_val = WfForm.getFieldValue(AccTaxRate_dt10+"_"+rowIndex);
        var AccTaxM_dt10_val = 0;
        if(AccCOST_dt10_val != "" && AccTaxRate_dt10_val !=""){
            AccTaxM_dt10_val = getse(AccCOST_dt10_val,AccTaxRate_dt10_val);
        }
