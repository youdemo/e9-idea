...
$(function() {
   ...
   // eval("JsonSeries=" + sexfb);
    ...
    chart = new Highcharts.Chart({
        ...
        xAxis: { //x轴
            categories: ['0-30', '31-50', '51-60','61-80','81-110','81-110','110+'],
            //X轴类别
            labels: {
                y: 18
            } //x轴标签位置：距X轴下方18像素
        ...
        series: [{type: 'column',name: '柱形',data:[100,200,150,350,200,178,20]}]
    });
