...
(function() {
    ...
    function za(a, b, c) {
        var d, e;
        if (Kb(b)) if (J(c)) a.setAttribute(b, c);
        else {
            if (a && a.getAttribute) e = a.getAttribute(b)
        } else if (J(b) && Eb(b)) for (d in b) a.setAttribute(d, b[d]);
        return e
    }
    function nc(a) {
    ...
    function Hd(a, b) {
        function c(m, h) {
            ...
            function ja(l, p) {
                ...
                if (!p) {
                    p = [1, 2, 2.5, 5, 10];
                    if (h.allowDecimals === false) if (Fb == 1) p = [1, 2, 5, 10];
                    else if (Fb <= 0.1) p = [1 / Fb]
                }
            ...
            function ga() {
                ...
                if (!Va && !Ic && !Mb && J(K) && J(P)) {
                    l = P - K || 1;
                    if (!J(h.min) && !J(pa) && Vb && (Ta < 0 || !Id)) K -= l * Vb;
                    if (!J(h.max) && !J(Na) && Kd && (u > 0 || !Jd)) P += l * Kd
                }
                Wa = K == P ? 1 : Mb && !T && Y == r.options.tickPixelInterval ? r.tickInterval: y(T, Va ? 1 : (P - K) * Y / A);
                if (!N && !J(h.tickInterval)) Wa = ja(Wa);
                s.tickInterval = Wa;
                ...
                if (N) {
                    ...
                    for (r = 0; r < C.length; r++) {
                        ...
                        S = na[1];
                        $ = na[2];
                        if (C[r + 1]) if (Wa <= (S * $[$.length - 1] + C[r + 1][1]) / 2) break
                    }
                    if (S == la && Wa < 5 * S) $ = [1, 2, 5];
                    C = ja(Wa / S, $);
                    $ = new Date(K * qb);
                    $.setMilliseconds(0);
                    if (S >= G) $.setSeconds(S >= B ? 0 : C * ob($.getSeconds() / C));
                    if (S >= B) $[Cd](S >= ia ? 0 : C * ob($[bd]() / C));
                    if (S >= ia) $[Dd](S >= Y ? 0 : C * ob($[cd]() / C));
                    if (S >= Y) $[ed](S >= o ? 1 : C * ob($[oc]() / C));
                    if (S >= o) {
                        $[Ed](S >= la ? 0 : C * ob($[Dc]() / C));
                        p = $[Ec]()
                    }
                    ...
                    for (ia = $[oc](); G < P && r < wa;) {
                        ra.push(G);
                        if (S == la) G = Cc(p + r * C, 0) / qb;
                        else if (S == o) G = Cc(p, B + r * C) / qb;
                        else if (!T && (S == Y || S == l)) G = Cc(p, B, ia + r * C * (S == Y ? 1 : 7));
                        else G += S * C;
                        r++
                    }
                    ra.push(G);
                ...
                if (!Mb) {
                    if (Va || ma && m.hasColumn) {
                        p = (Va ? 1 : Wa) * 0.5;
                        if (Va || !J(y(h.min, pa))) K -= p;
                        if (Va || !J(y(h.max, Na))) P += p
                    }
                    p = ra[0];
                    r = ra[ra.length - 1];
                    ...
                    if (!N && ra.length > Gb[H]) Gb[H] = ra.length
                }
            }
            function Ea() {
                var l, p;
                ...
                ha = D;
                D = A / (P - K || 1);
                if (!ma) for (l in ea) for (p in ea[l]) ea[l][p].cum = ea[l][p].total;
            ...
            function bb() {
                ...
                if (o || Mb) {
                    ...
                    Y || t((h.plotLines || []).concat(h.plotBands || []),
                    function(B) {
                ...
                t([sb, Wb, dc],
                function(B) {
                    for (var ia in B) if (B[ia].isActive) B[ia].isActive = false;
                    else {
                        B[ia].destroy();
                        delete B[ia]
                    }
            ...
            function Ja(l) {
                for (var p = Nb.length; p--;) Nb[p].id == l && Nb[p].destroy()
            }
            var ma = h.isX,
            Oa = h.opposite,
            M = Ga ? !ma: ma,
            ...
            function() {
                var l = this.value;
                return Kc ? Mc(Kc, l) : Wa % 1E6 === 0 ? l / 1E6 + "M": Wa % 1E3 === 0 ? l / 1E3 + "k": !Va && l >= 1E3 ? Gd(l, 0) : l
            },
            ...
            x.prototype = {
                addLabel: function() {
                    ...
                    o = qa(o, p.style);
                    if (T === Ra) this.label = J(l) && r && p.enabled ? aa.text(l, 0, 0).attr({
                        align: p.align,
                        rotation: p.rotation
                    }).css(o).add(tb) : null;
                    else T && T.attr({
            ...
            w.prototype = {
                render: function() {
                    ...
                    if (r && J(r.text) && C && C.length && wa > 0 && sa > 0) {
                        ...
                        r);
                        if (!o) l.label = o = aa.text(r.text, 0, 0).attr({
            ...
            Ka = function(l, p, r) {
                ...
                if (isNaN(l)) ia = true;
                    ...
                    o = ba;
                    Y = G - rb;
                    if (r < V || r > V + wa) ia = true
                } else {
                    r = V;
                    T = B - Ab;
                    if (o < ba || o > ba + sa) ia = true
                }
            ...
            qa(s, {
                ...
                getOffset: function() {
                    ...
                    if (l || Mb) {
                        t(ra,
                        function(B) {
                            if (sb[B]) sb[B].addLabel();
                            else sb[B] = new x(B);
                            if (E === 0 || E == 2 || {
                                1 : "left",
                                3 : "right"
                            } [E] == T.align) fc = Ca(sb[B].getLabelSize(), fc)
                        });
                        if (Nc) fc += (Nc - 1) * 16
                    } else for (var G in sb) {
                        sb[G].destroy();
                        delete sb[G]
                    }
                    if (o && o.text) {
                        if (!s.axisTitle) s.axisTitle = aa.text(o.text, 0, 0).attr({
                            zIndex: 7,
            ...
            return {
                ...
                refresh: function(H) {
                    ...
                    if (L) {
                        L = nc(L);
                        D = L.length;
                        for (var Hb; D--;) if (L[D] && (Hb = H.series[D ? "yAxis": "xAxis"])) {
                            ...
                            if (ga[D]) ga[D].attr({
                                ...
                                if (L[D].dashStyle) ha.dashstyle = L[D].dashStyle;
        ...
        function f(m, h) {
            ...
            Pc = function() {
                ...
                } else m.trackerGroup = Qc = aa.g("tracker").attr({
                    zIndex: 9
                }).add()
            };
            Pc();
            if (h.enabled) m.tooltip = rc = e(h); (function() {
                var E = true;
                ...
                var ea = function(s) {
                    if (! (s && s.touches && s.touches.length > 1)) {
                        s = x(s);
                        if (!Ib) s.returnValue = false;
                        var N = s.chartX,
                        Q = s.chartY,
                        H = !hc(N - V, Q - ba);
                        if (Ib && s.type == "touchstart") if (za(s.target, "isTracker")) m.runTrackerClick || s.preventDefault();
                        else ! ae && !H && s.preventDefault();
                        if (H) {
                            E || O();
                            if (N < V) N = V;
                            else if (N > V + wa) N = V + wa;
                            if (Q < ba) Q = ba;
                            else if (Q > ba + sa) Q = ba + sa
                        }
                        if (nd && s.type != "touchstart") {
                            if (Ea = Math.sqrt(Math.pow(L - N, 2) + Math.pow(ga - Q, 2)) > 10) {
                                if (ic && (Ja || ma) && hc(L - V, ga - ba)) ua || (ua = aa.rect(V, ba, Oa ? 1 : wa, M ? 1 : sa, 0).attr({
                            ...
                            if (rc && h.shared) {
                                A = [];
                                D = Ba.length;
                                for (ha = 0; ha < D; ha++) if (Ba[ha].visible && Ba[ha].tooltipPoints.length) {
                                    s = Ba[ha].tooltipPoints[va];
                                    s._dist = cb(va - s.plotX);
                                    xa = pb(xa, s._dist);
                                    A.push(s)
                                }
                                for (D = A.length; D--;) A[D]._dist > xa && A.splice(D, 1);
                ...
                ta.onclick = function(s) {
                    ...
                    s = x(s);
                    s.cancelBubble = true;
                    if (!Ea) if (N && za(s.target, "isTracker")) {
                        var Q = N.plotX,
                        H = N.plotY;
                        qa(N, {
        ...
        function g(m) {
            ...
            x = ub[h],
            w = q.hasRendered;
            if (w) if (Ga && h == "column") x = ub.bar;
            else if (!Ga && h == "bar") x = ub.column;
            h = new x;
            h.init(q, m);
        ...
        function n(m, h) {
            ...
            function(x) {
                ...
                if (x && x.text && !O) q[w] = aa.text(x.text, 0, 0).attr({
                    align: x.align,
                    "class": "highcharts-" + w,
                    zIndex: 1
        ...
        function z() {
            jb = v.renderTo;
            Od = Zb + qd++;
            if (Kb(jb)) jb = Aa.getElementById(jb);
            jb.innerHTML = "";
            if (!jb.offsetWidth) {
                Qb = jb.cloneNode(0);
                Ia(Qb, {
        ...
        function W() {
            ...
            if (!q.seriesGroup) q.seriesGroup = aa.g("series-group").attr({
                zIndex: 3
            }).add();
            t(Ba,
            function(w) {
        ...
        function ca() {
            ...
            if (aa) aa.alignedObjects = null;
            clearInterval(Nd);
            for (m in q) delete q[m]
        }
        function ka() {
            if (!wc && ib == ib.top && Aa.readyState != "complete") Aa.attachEvent("onreadystatechange",
            function() {
        ...
        be = function(m) {
            ...
            function O(u) {
                var Z, pa, Na, P, K, gb = u.legendItem;
                P = u.series || u;
                if (!gb) {
                    K = /^(bar|pie|area|column)$/.test(P.type);
                    u.legendItem = gb = aa.text(L.labelFormatter.call(u), 0, 0).css(u.visible ? ma: M).on("mouseover",
                    function() {
                        u.setState(yb);
                        gb.css(Oa)
                    }).on("mouseout",
                    ...
                    if (K) Z = aa.rect(pa = -Ea - ua, Na = -11, Ea, 12, 2).attr({
                        "stroke-width": 0,
                        zIndex: 3
                    }).add(Ka);
                    else if (u.options && u.options.marker && u.options.marker.enabled) Z = aa.symbol(u.symbol, pa = -Ea / 2 - ua, Na = -4, u.options.marker.radius).attr(u.pointAttr[db]).attr({
                        zIndex: 3
                    }).add(Ka);
                    if (Z) {
                        Z.xOff = pa;
            ...
            function ja() {
                ...
                if (xa || va) {
                    Rb += 2 * E;
                    Sb += 2 * E;
                    if (ha) Rb > 0 && Sb > 0 && ha.animate(ha.crisp(null, null, null, Rb, Sb));
                    else ha = aa.rect(0, 0, Rb, Sb, L.borderRadius, xa || 0).attr({
            ...
            if (L.enabled) {
                ...
                return {
                    ...
                    destroyItem: function(u) {
                        var Z = u.checkbox;
                        t(["legendItem", "legendLine", "legendSymbol"],
                        function(pa) {
                            u[pa] && u[pa].destroy()
                        });
                        Z && Fc(u.checkbox)
        ...
        md = function(m) {
            var h = Sa.lang,
            x = q.pointCount < 100;
            q.toolbar.add("zoom", h.resetZoom, h.resetZoomTitle, Td); ! m || m.resetSelection ? t(ab,
            function(w) {
        ...
        sc = function() {
            ...
            L;
            sd();
            if ((q.title || q.subtitle) && !J(da)) if (L = Ca(q.title && !kc.floating && !kc.verticalAlign && kc.y || 0, q.subtitle && !tc.floating && !tc.verticalAlign && tc.y || 0)) ba = Ca(ba, L + y(kc.margin, 15) + Ha);
            if (m.enabled && !m.floating) if (O == "right") J(X) || (Ab = Ca(Ab, Rb - x + h + Ya));
            else if (O == "left") J(R) || (V = Ca(V, Rb + x + h + Vc));
            else if (ja == "top") J(da) || (ba = Ca(ba, Sb + w + h + Ha));
            else if (ja == "bottom") J(U) || (rb = Ca(rb, Sb - w + h + ud));
            ic && t(ab,
            function(ga) {
                ga.getOffset()
            });
        ...
        pd = function() {
            ...
            O = m + (v.shadow ? 8 : 0);
            if (m || h) if (Wc) Wc.animate(Wc.crisp(null, null, null, Xa - O, Pa - O));
            else Wc = aa.rect(O / 2, O / 2, Xa - O, Pa - O, v.borderRadius, m).attr({
                stroke: v.borderColor,
                "stroke-width": m,
                fill: h || nb
            }).add().shadow(v.shadow);
            if (x) if (vd) vd.animate(ja);
            else vd = aa.rect(V, ba, wa, sa, 0).attr({
                fill: x
            }).add().shadow(v.plotShadow);
            if (w) if (wd) wd.animate(ja);
            else wd = aa.image(w, V, ba, wa, sa).add();
            if (v.plotBorderWidth) if (Xc) Xc.animate(Xc.crisp(null, V, ba, wa, sa));
            else Xc = aa.rect(V, ba, wa, sa, 0, v.plotBorderWidth).attr({
	...
	*/
    Sa = {
        colors: ["#00BBF0", "#2472C3", "#89A54E", "#80699B", "red", "#DB843D", "#92A8CD", "#A47D7C", "#B5CA92"],
    ...
    var Ub = function(a) {
        var b = [],
        c; (function(d) {
            if (c = /rgba\(\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*,\s*([0-9]?(?:\.[0-9]+)?)\s*\)/.exec(d)) b = [oa(c[1]), oa(c[2]), oa(c[3]), parseFloat(c[4], 10)];
            else if (c = /#([a-fA-F0-9]{2})([a-fA-F0-9]{2})([a-fA-F0-9]{2})/.exec(d)) b = [oa(c[1], 16), oa(c[2], 16), oa(c[3], 16), 1]
        })(a);
        return {
            get: function(d) {
    ...
    Hc.prototype = {
        ...
        attr: function(a, b) {
            ...
            if (Kb(a)) {
                ...
                if (c == "d") {
                    ...
                    if (this.rotation) za(g, "transform", "rotate(" + this.rotation + " " + d + " " + oa(a.y || za(g, "y")) + ")")
                    ...
                    if (d) {
                        ...
                        for (e = d.length; e--;) d[e] = oa(d[e]) * a["stroke-width"];
                        d = d.join(",")
                    }
                } else if (c == "isTracker") this[c] = d;
                else if (c == "width") d = oa(d);
                else if (c == "align") {
                    c = "text-anchor";
                    d = {
                        left: "start",
                ...
                if (n && /^(width|height|visibility|x|y|d)$/.test(c)) for (e = n.length; e--;) za(n[e], c, d);
                if (c == "text") {
                    this.textStr = d;
        ...
        crisp: function(a, b, c, d, e) {
            ...
            i.strokeWidth = a;
            for (f in i) if (this[f] != i[f]) this[f] = g[f] = i[f];
            return g
        },
        css: function(a) {
            var b = this.element;
        ...
        destroy: function() {
            ...
            c && c.removeChild(a);
            b && t(b,
            function(e) { (c = e.parentNode) && c.removeChild(e)
            });
    ...
    Uc.prototype = {
        ...
        buildText: function(a) {
            for (var b = a.element,
            c = y(a.textStr, "").toString().replace(/<(b|strong)>/g, '<span style="font-weight:bold">').replace(/<(i|em)>/g, '<span style="font-style:italic">').replace(/<a/g, "<span").replace(/<\/(b|strong|i|em|a)>/g, "</span>").split(/<br[^>]?>/g), d = b.childNodes, e = /style="([^"]+)"/, f = /href="([^"]+)"/, g = za(b, "x"), i = a.styles, k = Rd && i && i.HcDirection == "rtl" && !this.forExport, j, n = i && oa(i.width), z = i && i.lineHeight, F, W = d.length; W--;) b.removeChild(d[W]);
            ...
            function(ca, ka) {
                ...
                function(X) {
                    if (X !== "" || v.length == 1) {
                        ...
                        if (k) {
                            j = [];
                            for (W = X.length; W--;) j.push(X.charAt(W));
                            X = j.join("")
                        }
                        ...
                        if (!I) {
                            if (ka) {
                                ...
                                if (isNaN(da)) da = z || F.offsetHeight || 18;
                                za(R, "dy", da)
                            }
                            F = R
                        }
        ...
        crispLine: function(a, b) {
            if (a[1] == a[4]) a[1] = a[4] = fa(a[1]) + b % 2 / 2;
            if (a[2] == a[5]) a[2] = a[5] = fa(a[2]) + b % 2 / 2;
            return a
        },
        path: function(a) {
        ...
        circle: function(a, b, c) {
			...
			/*return this.createElement("circle").attr(a)  返回上圆点*/
            return this.createElement("circl").attr(a)
        },
    ...
    if (!wc) {
        var ge = xb(Hc, {
            init: function(a, b) {
                ...
                if (yc) d.push("visibility: ", b == Lb ? vb: Bb);
                c.push(' style="', d.join(""), '"/>');
                if (b) {
            ...
            attr: function(a, b) {
                ...
                if (Kb(a)) {
                    ...
                    if (j && /^(x|y|r|start|end|width|height|innerR)/.test(c)) {
                        ...
                        this.d = d.join(" ");
                        e = d.length;
                        for (n = []; e--;) n[e] = ac(d[e]) ? fa(d[e] * 10) - 5 : d[e] == "Z" ? "x": d[e];
                        d = n.join(" ") || "x";
                        f.path = d;
                        ...
                        this[c] = d;
                        if (ac(d)) d += $a
                    } else if (c == "dashstyle") { (f.getElementsByTagName("stroke")[0] || fb(k.prepVML(["<stroke/>"]), null, null, f))[c] = d || "solid";
                        this.dashstyle = d;
                        n = true
        ...
        Ma.prototype = ya(Uc.prototype, {
            ...
            symbols: {
                arc: function(a, b, c, d) {
                    ...
                    z = d && 0.1 / d || 0;
                    if (f - e === 0) return ["x"];
                    else if (2 * Tb - f + e < n) k = -n;
                    else if (f - e < z) k = kb(e + z);
    ...
    zc.prototype = {
        ...
        destroy: function() {
            ...
            Cb(a);
            t(["graphic", "tracker", "group", "dataLabel", "connector"],
            function(d) {
                a[d] && a[d].destroy()
            });
        ...
        setState: function(a) {
            ...
            if (! (a == this.state || this.selected && a != "select" || c[a] && c[a].enabled === false || a && (f || e && !d.enabled))) {
                if (this.graphic) this.graphic.attr(k[a]);
                else {
                    if (a) {
                        if (!g) b.stateMarkerGraphic = g = i.renderer.circle(0, 0, k[a].r).attr(k[a]).add(b.group);
    ...
    mb.prototype = {
        ...
        translate: function() {
            ...
            f = e.length; f--;) {
                ...
                if (J(j)) g.yBottom = d.translate(j, 0, 1);
                if (k !== null) g.plotY = d.translate(k, 0, 1);
        ...
        setTooltipPoints: function(a) {
            ...
            function(k, j) {
                ...
                for (g = k.high = d[j + 1] ? ob((k.plotX + (d[j + 1] ? d[j + 1].plotX: e)) / 2) : e; f <= g;) i[c ? e - f++:f++] = k
            });
        ...
        getAttribs: function() {
            ...
            for (f = i.length; f--;) {
                ...
                e = false;
                if (g.options) for (var z in n) if (J(b[n[z]])) e = true;
                if (e) {
                    j = [];
                    c = b.states || {};
                    e = c[yb] = c[yb] || {};
        ...
        drawDataLabels: function() {
            if (this.options.dataLabels.enabled) {
                ...
                function(n) {
                    ...
                    else if (J(e)) W = n.dataLabel = g.renderer.text(e, a, b).attr({
                        align: ca,
                        rotation: d.rotation,
                        zIndex: 1
                    }).css(d.style).add(f);
        ...
        drawGraph: function() {
            ...
            function(v) {
                ...
                t(v,
                function(U, R) {
                    if (a.getPointSpline) n.push.apply(n, a.getPointSpline(v, U, R));
                    else {
                        n.push(R ? Da: Za);
                ...
                if (W) {
                    ...
                    da,
                    X = n.length;
                    for (da = 0; da < X; da++) I.push(n[da]);
                    X == 3 && I.push(Da, n[1], n[2]);
                    if (b.stacking && a.type != "areaspline") for (da = v.length - 1; da >= 0; da--) I.push(v[da].plotX, v[da].yBottom);
                    else I.push(Da, v[v.length - 1].plotX, F, Da, v[0].plotX, F);
                    ka = ka.concat(I)
                }
            });
            a.graphPath = d;
        ...
        setVisible: function(a, b) {
            ...
            this.isDirty = true;
            this.options.stacking && t(c.series,
            function(n) {
        ...
        drawTracker: function() {
            ...
            if (d) for (j = d + 1; j--;) {
                ...
                if (j && c[j] == Za || j == d) c.splice(j, 0, Da, c[j - 2] + f, c[j - 1])
            }
    ...
    Ma = xb(mb, {
        ...
        drawPoints: function() {
            ...
            function(g) {
                ...
                e.translate(c[0], c[1]);
                if (d) d.animate(f);
                else g.graphic = b.arc(f).attr(qa(g.pointAttr[db], {
                ...
                for (v = 0; v < 2; v++) {
                    ...
                    for (R = 0; R < F[U].length; R++) {
                        ...
                        if (g = b.dataLabel) {
                            ...
                            if (k) if (v && b.rank < a) ka = vb;
                            else if (!da && ca < n + j || da && ca > n - j) {
                                ca = n + I * j;
                                W = this.getX(ca, U > 1);
                                if (!da && ca + j > z || da && ca - j < z) if (v) ka = vb;
                                else a++
                            }
                            if (b.visible === false) ka = vb;
                            if (ka == Bb) n = ca;
                            if (v) {
                                g.attr({
                                    visibility: ka,
