			...
			<div class="advancedSearchDiv" id="advancedSearchDiv" style="display:none;">
				...
				<wea:item>日期</wea:item>
					<wea:item>
						...
						<INPUT type="hidden" name="beginDate" id="beginDate" value="<%=searchday%>">
    ...
    <tbody>		
        <tr>			
            ...
            <table class="ViewForm1  maintable" scrolling="auto">
                <colgroup>  <col width="100px"></col><col width="200px"></col><col width="200px"></col><col width="200px"></col><col width="200px"></col>
				 </colgroup>
                <tbody>
				<tr>

					<td class="fname"  align="center" colspan="5" ><%=year%>年<%=month%>月<%=day%>日车辆使用情况</td>
				</tr>
				<tr>
	                    <td class="fvalue"  align="center" rowspan="2" >姓名/工号</td>
						<td class="fvalue"  align="center" >范炳旺</td>
						<td class="fvalue"  align="center" >李永红</td>
						<td class="fvalue"  align="center" >谢江平</td>
					    <td class="fvalue"  align="center" >林小东</td>
					</tr>	
					 <tr>
						<td class="fvalue"  align="center" >A1101001</td>
				...
				<tr>
					...
					<td class="fvalue"  align="center" >苏E03T8V//苏EG83X0</td>
                ...
                String ccrymd = "";
                String jsy = "";
                String sql = "select yjccsj,yjfhsj,ccrymd,mdd,(select lastname from hrmresource where id=a.jsy) as jsy from formtable_main_68 a,workflow_requestbase b where a.requestId=b.requestid and b.currentnodetype<=3 and subString(yjccsj,0,11)='"+searchday+"' order by yjccsj asc";
                rs.execute(sql);
                while(rs.next()){
                    String ccrynames ="";
                    ...
                    String ycqk = Util.null2String(rs.getString("yjccsj"))+" "+ccrynames+" "+Util.null2String(rs.getString("mdd"))+" "+Util.null2String(rs.getString("yjfhsj"));
                    jsy = Util.null2String(rs.getString("jsy"));
                    if("范炳旺".equals(jsy)){
                        list1.add(ycqk);
                    }else if("李永红".equals(jsy)){
                        list2.add(ycqk);
                    }else if("谢江平".equals(jsy)){
                        list3.add(ycqk);
                    }else if("林小东".equals(jsy)){
                        list4.add(ycqk);
                    }
                }
