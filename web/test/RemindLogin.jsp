...
<%
	...
	String comid = "";
		sql = "select id,supsubcomid from hrmsubcompany where id=(select subcompanyid1 from hrmresource where id="+user.getUID()+")";
		RecordSet.executeSql(sql);
		if(RecordSet.next()){
			comid = Util.null2String(RecordSet.getString("id"));
		}
	BaseBean log = new BaseBean();
	log.writeLog("loginuser="+user.getUID()+"=gongsiid="+comid);
%>
<html> 
	<head>
...
<%
	...
	if("221".equals(comid) || "541".equals(comid)){
